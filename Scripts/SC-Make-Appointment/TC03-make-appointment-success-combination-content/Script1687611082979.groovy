...
try {
    ...
    WebUI.click(findTestObject('Page_CURA Healthcare Service/make_appointment_page/radiobuttonPrograms', [('textProgram') : program
                , ('index') : healthCareIndex]))

    WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/make_appointment_page/textfieldVisitDate'), 
        visitDate)

    WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/make_appointment_page/textfieldComment'), 
        comment)
